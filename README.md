# Orders of deparment of Medical Education and Drugs Department Government of Maharashtra

This is a data package repository that process orders obtained from department of Medical Education and Drugs Department Government of Maharasthra. The data is obtained by processing orders from Government of Maharashtra's [Orders Website](https://gr.maharashtra.gov.in/1145/Government-Resolutions) website.
...
1. [mahmed-*.pdf.en.txt](flow/writeTxt_/output/): Orders in Marathi.

2. [mahmed-*.pdf.mr.txt](flow/writeTxt_/output/): Orders in English.
...
## Data Details
- **First Order:** [201803121137094813.pdf](https://gr.maharashtra.gov.in/Site/Upload/Government%20Resolutions/English/201803121137094813.pdf) (12 March 2018)
- **Last Order:** [202309271110104813.pdf](https://gr.maharashtra.gov.in/Site/Upload/Government%20Resolutions/English/202309271110104813.pdf) (27 September 2023)
- **Last Crawl Date:** 01-Oct-2023
- **Total Orders:** 905
- **Translated Orders:** 861
...
```
git clone https://github.com/orgpedia/mahmed.git
```
