...
import/websites/gr.maharashtra.gov.in/MedicalEdu:
	cd import/websites/gr.maharashtra.gov.in/ && ln -s $(GR_DIR)/MedicalEdu .
...
import: check_env import/websites/gr.maharashtra.gov.in/MedicalEdu .secrets/google.token 
	poetry run python import/src/build_documents.py import/websites/gr.maharashtra.gov.in/MedicalEdu import/documents
